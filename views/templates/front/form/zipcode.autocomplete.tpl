<div style="display: flex">
  ...
  <input class="btn btn-primary" id="dealt-offer-submit" type="submit" value="
	{if ($cartProduct != null)}
    ADD TO CART
  {else} ADD TO CART WITH SERVICE{/if}" data-dealt-offer-id={$offer->getDealtOfferId()}
    data-dealt-offer-unit-price={$offer->getPrice()}
